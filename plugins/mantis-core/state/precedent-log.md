...
Self-observed operational failures for future-self to grep before risky ops in the M1 walker / M2 structural-diff pipeline. Format per `shared/foundations/conduct/precedent.md`. Append; never delete without marking `RESOLVED YYYY-MM-DD`.
