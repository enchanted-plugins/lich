...
Self-observed operational failures for the M5 Bounded Subprocess Dry-Run engine. Format per `shared/foundations/conduct/precedent.md`. Append; never delete without marking `RESOLVED YYYY-MM-DD`.
