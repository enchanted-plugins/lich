...
Log operational failures (Python version incompatibility, resource module absent, temp-dir write denied) to `plugins/lich-sandbox/state/precedent-log.md` per `@shared/foundations/conduct/precedent.md`.

See [@shared/foundations/conduct/delegation.md](../../../shared/foundations/conduct/delegation.md) § Trust but verify the subagent.
