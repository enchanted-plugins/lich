...
Schema per entry (tagged with one code from shared/vis/conduct/failure-modes.md):
...
# -----------------------------------------------------------------------------
# Canonical F-codes (shared/vis/conduct/failure-modes.md)
# -----------------------------------------------------------------------------
    ...
    def __post_init__(self) -> None:
        if self.code not in VALID_CODES:
            raise ValueError(
                ...
                f"(see shared/vis/conduct/failure-modes.md)"
            )
